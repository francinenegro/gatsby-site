...
The results confirmed the assumption and made emerge a range issues while they also gave us an idea which way to proceed in terms of implementation: start simple and add complexity.</p>
    ...
    <p>The interface was then presented to the stakeholders and refined to integrate inputs from the stakeholders. The design tested was then modified to incorporate the re organization of another existing feature and a new one (which had been in roadmap for awhile).
KPIs were also defined in order to monitor the feature’s success starting at the month mark after the implementation (uses of the feature vs. traditional transfers, overall use and companies that use the feature), another point I made sure to add was improving communication of the feature when released.</p>
