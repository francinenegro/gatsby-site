...
const ProjectPage = () => (
  <Layout>
    ...
    <a href="index"><i class="material-icons md-48" >arrow_back</i></a>
      <h2>Tes Elements</h2>
            <h3>Making taxonomy navigation children friendly.<br></br> 
            <br></br>Tes is a leading  teacher-focused EdTech company, whose products range from various job boards, a teaching resources marketplace, news sections and online and offline courses. Tes Elements - which sits in the resources marketplace - is a subscription-only set of primary and secondary teaching resources.</h3>
        </div>
        </div>
        </div>
